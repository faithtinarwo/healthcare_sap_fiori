sap.ui.define([
  ...
  return Controller.extend("hc.dashboard.view.App", {
    onInit: function () {
      ...
      /* ---------- features ---------- */
      this._initDarkMode();          // 🌓 dark-mode toggle
      this._initAlerts();            //  🔔 auto-alert simulation
      this._initExport();            //  📤 csv export helper
    },
    ...
    /* ===========================================================
       4.  AUTO-ALERT  (new critical patient every 30 s)
    =========================================================== */
    ...
    /* ===========================================================
       5.  CSV EXPORT
    =========================================================== */
    _initExport: function () {/*button press handler*/
